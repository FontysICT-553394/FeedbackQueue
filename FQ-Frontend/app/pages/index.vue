...
<template>
  <main class="main-content">
    <section class="hero-section">
      ...
      <p v-if="className === undefined" class="hero-subtitle">Loading...</p>
      <p v-else-if="className === null" class="hero-subtitle">Enroll in a class and join your teachers queue and wait for feedback!</p>
